...
void SoftSerial_Degub_print( uint8_t num , int type = DEC );
void SoftSerial_Degub_print( uint16_t num , int type = DEC );
...
void SoftSerial_Degub_println( uint8_t num , int type = DEC );
void SoftSerial_Degub_println( uint16_t num , int type = DEC );
